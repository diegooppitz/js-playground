...
import { californiaValidYear, ohioInvalidYear, ohioValidYear, baseValue, federalTaxRate } from "../mock";
...
export class TaxSystem {
    initSystem() {
        ...
        // product 2
        const productTaxStates2 = generateProductData(ohioValidYear, baseValue, federalTaxRate)
        ...
        const productTaxStates3 = generateProductData(ohioInvalidYear, baseValue, federalTaxRate)
